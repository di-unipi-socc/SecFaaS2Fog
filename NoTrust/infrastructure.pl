...
%provider1
node(edge1, provider1, [data_encryption], [python,javascript,java], (1024,2,2000)).
node(edge2, provider1, [data_encryption, antitampering],    [python, java], (2048,2, 4000)).
%provider2
%node(edge3, provider2, [antitampering],                     [javascript, java]).
%node(edge4, provider2, [data_encryption,antitampering],     [python,java]).
%provider3
node(edge5, provider3, [data_encryption,antitampering],     [java], (4096, 4, 3000) ).
node(edge6, provider3, [wireless_security,antitampering],   [java],(8192,8, 4000) ).
